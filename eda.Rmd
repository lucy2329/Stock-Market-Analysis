...
ggplot(data=y, aes(c1, prop)) + geom_bar(stat="identity") +theme(axis.text.x = element_text(angle = 90, hjust = 1)) + xlab("Company") + ggtitle("CAGR vs Proportion of Positive Years")
